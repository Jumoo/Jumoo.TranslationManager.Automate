<#
SYNOPSIS
    Builds and optionally pushes the Jumoo.TranslationManager.Automate package.
#>
param (
...
dotnet pack ..\Jumoo.TranslationManager.Automate\Jumoo.TranslationManager.Automate.csproj --no-restore -c $env -o $outFolder /p:$buildParams
...
Write-Host "Jumoo.TranslationManager.Automate Packaged : $fullVersion"
